...
let createForm () =
    ...
    let searchTextBox = new TextBox(Location = Point(120, 270), Width = 200)
    form.Controls.Add(searchTextBox)

    // Create and configure the Search Label
    let SearchLabel = new Label(Text = "Search:", Location = Point(10, 270), Width = 100)
    form.Controls.Add(SearchLabel)

    // Create the DataGridView for displaying search results
    let SearchView = new DataGridView(Location = Point(10, 310), Size = Size(360, 150))
